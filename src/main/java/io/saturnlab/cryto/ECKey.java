...
import io.saturnlab.cryto.jce.ECKeyAgreement;
import io.saturnlab.cryto.jce.ECKeyFactory;
import io.saturnlab.cryto.jce.ECKeyPairGenerator;
import io.saturnlab.cryto.jce.ECSignatureFactory;
import io.saturnlab.cryto.jce.SpongyCastleProvider;
...
public class ECKey implements Serializable {
  ...
  public static class ECDSASignature implements Serializable{
    ...
    public static boolean validateComponents(BigInteger r, BigInteger s, byte v) {
      ...
      if (!(r.compareTo(SECP256K1N) < 0)) return false;
      if (!(s.compareTo(SECP256K1N) < 0)) return false;
